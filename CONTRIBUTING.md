...
Thanks for considering contributing to stochLAB! The resources in this
tool will be used for assessing impacts of offshore turbines on marine
birds in order to help balance the trade-offs between conservation and
climate change mitigation.

## Code of conduct

Please note that this project is released with a [Contributor Code of
Conduct](https://marinescotlandscience.github.io/stochLAB/CONDUCT.md).
...
Think stochLAB is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using stochLAB for a paper you are writing? Consider [citing
it](https://marinescotlandscience.github.io/stochLAB/authors.html).

### Ask a question ⁉️

Using our_package and got stuck? Browse the
[documentation](https://marinescotlandscience.github.io/stochLAB) to see
if you can find a solution. Still stuck? Post your question as an [issue
on
GitHub](https://github.com/MarineScotlandScience/stochLAB/issues/new).
...
[documentation](https://marinescotlandscience.github.io/stochLAB) and
[issue list](https://github.com/MarineScotlandScience/stochLAB/issues)
...
GitHub](https://github.com/MarineScotlandScience/stochLAB/issues/new) so
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/MarineScotlandScience/stochLAB).
...
list](https://github.com/MarineScotlandScience/stochLAB/issues) and
...
1.  Fork [this repo](https://github.com/MarineScotlandScience/stochLAB)
...
This package is in a stable state of development, with minimal
