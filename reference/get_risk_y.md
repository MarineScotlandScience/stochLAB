...
Calculates the single transit collision risk/probability along the
horizontal chord of the rotor at height \\y\\ via numerical integration.
...
- x_at_y:
  ...
  a vector, sequence of horizontal distances from rotor's vertical axis
  to points \\x\\ along half of the rotor circle, expressed as the
  proportion of rotor radius, at height band \\y\\

- pcoll_doty:

  a vector, the single transit collision risk at horizontal distances
  \\x\\, at height band \\y\\
...
[`get_pcoll_grid()`](https://marinescotlandscience.github.io/stochLAB/reference/get_pcoll_grid.md)
